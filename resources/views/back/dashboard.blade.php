@extends('layouts.dashboard') @section('title') Salus Trust @endsection @section('active') active @endsection @section('content')
            ...
            <div class="menu">
                <ul class="list">
                    <li>
                        <div class="user-info">
                            <div class="image">
                                <a href="https://thememakker.com/templates/oreo/hospital/laravel/public/doctor/profile"><img src="/back/images/profile_av.jpg" alt="User"></a>
                            </div>
                            <div class="detail">
                                <h4>Dr. Charlotte</h4>
                    ...
                    <li class=""><a href="https://thememakker.com/templates/oreo/hospital/laravel/public/appointment/book-appointment"><i class="zmdi zmdi-calendar-check"></i><span>Appointment</span></a></li>
                    <li class="">
                        <a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-account-add"></i><span>Doctors</span></a>
                        <ul class="ml-menu">
                            <li class=""><a href="https://thememakker.com/templates/oreo/hospital/laravel/public/doctor/doctors">All Doctors</a></li>
                            <li class=""><a href="https://thememakker.com/templates/oreo/hospital/laravel/public/doctor/add-doctor">Add Doctor</a></li>
                            <li class=""><a href="https://thememakker.com/templates/oreo/hospital/laravel/public/doctor/profile">Doctor Profile</a></li>
                            <li class=""><a href="https://thememakker.com/templates/oreo/hospital/laravel/public/doctor/events">Doctor Schedule</a></li>
                        </ul>
                    </li>
                    <li class="">
                        <a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-account-o"></i><span>Patients</span></a>
                        <ul class="ml-menu">
                            <li class=""><a href="https://thememakker.com/templates/oreo/hospital/laravel/public/patients/all-patients">All Patients</a></li>
                            <li class=""><a href="https://thememakker.com/templates/oreo/hospital/laravel/public/patients/add-patients">Add Patient</a></li>
                            <li class=""><a href="https://thememakker.com/templates/oreo/hospital/laravel/public/patients/patients-profile">Patient Profile</a></li>
                            <li class=""><a href="https://thememakker.com/templates/oreo/hospital/laravel/public/patients/invoice">Invoice</a></li>
                        </ul>
                    </li>
                    <li class="">
                        <a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-balance-wallet"></i><span>Payments</span></a>
                        <ul class="ml-menu">
                            <li class=""><a href="https://thememakker.com/templates/oreo/hospital/laravel/public/payment/all-payment">All Payments</a></li>
                            <li class=""><a href="https://thememakker.com/templates/oreo/hospital/laravel/public/payment/add-payment">Add Payment</a></li>
                            <li class=""><a href="https://thememakker.com/templates/oreo/hospital/laravel/public/patients/invoice">Invoice</a></li>
                        </ul>
                    </li>
                    <li class="">
                        ...
                        <ul class="ml-menu">
                            <li class=""><a href="https://thememakker.com/templates/oreo/hospital/laravel/public/departments/add-department">Add</a></li>
                            <li class=""><a href="https://thememakker.com/templates/oreo/hospital/laravel/public/departments/all-departments">All Departments</a></li>
                    ...
                    <li>
                        ...
                        <ul class="ml-menu">
                            <li><a href="https://thememakker.com/templates/oreo/hospital/laravel/public/authentication/login">Sign In</a></li>
                            <li><a href="https://thememakker.com/templates/oreo/hospital/laravel/public/authentication/register">Sign Up</a></li>
                            <li><a href="https://thememakker.com/templates/oreo/hospital/laravel/public/authentication/forgot-password">Forgot Password</a></li>
                            <li><a href="https://thememakker.com/templates/oreo/hospital/laravel/public/authentication/page404">Page 404</a></li>
                            <li><a href="https://thememakker.com/templates/oreo/hospital/laravel/public/authentication/page500">Page 500</a></li>
                            <li><a href="https://thememakker.com/templates/oreo/hospital/laravel/public/authentication/page-offline">Page Offline</a></li>
                            <li><a href="https://thememakker.com/templates/oreo/hospital/laravel/public/authentication/lockscreen">Locked Screen</a></li>
                        </ul>
                    </li>
                ...
                <div class="card">
                    ...
                    <ul class="list-unstyled">
                        ...
                        <li class="me">
                            <a href="javascript:void(0);">
                                <div class="media">
                                    <img class="media-object " src="/back/images/xs/avatar1.jpg" alt="">
                                    <div class="media-body">
                ...
                <div class="card">
                    ...
                    <ul class="list-unstyled">
                        <li class="offline inlineblock">
                            <a href="javascript:void(0);">
                                <div class="media">
                                    <img class="media-object " src="/back/images/xs/avatar10.jpg" alt="">
                                    <div class="media-body">
                                        <span class="badge badge-outline status"></span>
                                    </div>
                                </div>
                        ...
                        <li class="offline inlineblock">
                            <a href="javascript:void(0);">
                                <div class="media">
                                    <img class="media-object " src="/back/images/xs/avatar7.jpg" alt="">
                                    <div class="media-body">
                                        <span class="badge badge-outline status"></span>
                                    </div>
                                </div>
                        ...
                        <li class="offline inlineblock">
                            <a href="javascript:void(0);">
                                <div class="media">
                                    <img class="media-object " src="/back/images/xs/avatar8.jpg" alt="">
                                    <div class="media-body">
                                        <span class="badge badge-outline status"></span>
                                    </div>
                                </div>
                        ...
                        <li class="offline inlineblock">
                            <a href="javascript:void(0);">
                                <div class="media">
                                    <img class="media-object " src="/back/images/xs/avatar9.jpg" alt="">
                                    <div class="media-body">
                                        <span class="badge badge-outline status"></span>
                                    </div>
                                </div>
            ...
            <div class="slim_scroll">
                <div class="card user_activity">
                    ...
                    <div class="streamline b-accent">
                        <div class="sl-item">
                            <img class="user rounded-circle" src="/back/images/xs/avatar4.jpg" alt="">
                        ...
                        <div class="sl-item">
                            <img class="user rounded-circle" src="/back/images/xs/avatar5.jpg" alt="">
                            <div class="sl-content">
                        ...
                        <div class="sl-item">
                            <img class="user rounded-circle" src="/back/images/xs/avatar6.jpg" alt="">
                            <div class="sl-content">
                        ...
                        <div class="sl-item">
                            <img class="user rounded-circle" src="/back/images/xs/avatar7.jpg" alt="">
                            <div class="sl-content">
            ...
            <div class="chat-widget">
                <ul class="chat-scroll-list clearfix">
                    <li class="left float-left">
                        <img src="/back/images/xs/avatar3.jpg" class="rounded-circle" alt="">
                        <div class="chat-info">
                    ...
                    <li class="left float-left"> <img src="/back/images/xs/avatar2.jpg" class="rounded-circle" alt="">
                    ...
                    <li class="left float-left"> <img src="/back/images/xs/avatar1.jpg" class="rounded-circle" alt="">
                                ...
                                <div class="table-responsive">
                                    <table class="table m-b-0 table-hover">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>Hospital Name</td>
                                                <td class="d-none d-md-inline-block">Porterfield 508 Virginia Street Chicago, IL 60653</td>
                                                <td>$2,325</td>
                                            ...
                                            <tr>
                                                <td>Hospital Name</td>
                                                <td class="d-none d-md-inline-block">2595 Pearlman Avenue Sudbury, MA 01776 </td>
                                                <td>$3,325</td>
                                                <td class="d-none d-lg-inline-block">
                                                    <i class="zmdi zmdi-star col-amber"></i>
                                                    <i class="zmdi zmdi-star col-amber"></i>
                                            ...
                                            <tr>
                                                <td>Hospital Name</td>
                                                <td class="d-none d-md-inline-block">508 Virginia Street Chicago, IL 60653</td>
                                                <td>$1,325</td>
                                                <td class="d-none d-lg-inline-block">
                                                    <i class="zmdi zmdi-star col-amber"></i>
                                                    <i class="zmdi zmdi-star col-amber"></i>
                                            ...
                                            <tr>
                                                <td>Hospital Name</td>
                                                <td class="d-none d-md-inline-block">1516 Holt Street West Palm Beach, FL 33401</td>
                                                <td>$2,325</td>
                                                <td class="d-none d-lg-inline-block">
                                                    <i class="zmdi zmdi-star col-amber"></i>
                                                    <i class="zmdi zmdi-star col-amber"></i>
...
<!-- Scripts -->
<script src="/back/bundles/libscripts.bundle.js"></script>
<script src="/back/bundles/vendorscripts.bundle.js"></script>

<script src="/back/bundles/mainscripts.bundle.js"></script>
<script src="/back/bundles/morrisscripts.bundle.js"></script>
<script src="/back/bundles/jvectormap.bundle.js"></script>
<script src="/back/bundles/knob.bundle.js"></script>
<script src="/back/js/pages/index.js"></script>
